...
public:
    ...
    enum {
        WDT0_BASE                   = 0x1000F000, // Definido
        WDT1_BASE                   = 0x10010000, // Definido
        I2C0_BASE                   = 0x40002000, // I2C
        GPIOA_BASE                  = 0x10013000, // Definido
        GPIOB_BASE                  = 0x10014000, // Definido
        GPIOC_BASE                  = 0x10015000, // Definido
        //GPIOD_BASE                  = 0x40007000, // PrimeCell PL061 GPIO
        USART_BASE                  = 0x40008000, // PrimeCell PL022 Synchronous Serial Port
        UART0_BASE                  = 0x10009000, // Definido
        UART1_BASE                  = 0x1000A000, // Definido
        UART2_BASE                  = 0x1000B000, // Definido
        UART3_BASE                  = 0x1000C000, // Definido
        I2C1_BASE                   = 0x40020000, // I2C
        I2C2_BASE                   = 0x40021000, // I2C
        //GPIOE_BASE                  = 0x40024000, // PrimeCell PL061 GPIO
        TIMER0_BASE                 = 0x10011000, // Definido
        TIMER1_BASE                 = 0x10012000, // Definido
        TIMER2_BASE                 = 0x10018000, // Definido
        TIMER3_BASE                 = 0x10019000, // Definido
        ADC0_BASE                   = 0x40038000, // ADC
        FLASH0_BASE                 = 0x400fd000, // Flash Controller
        SCR0_BASE                   = 0x10001000, // Definido
        SCR1_BASE                   = 0x1001A000, // Definido
        IC0_BASE                    = 0x1E020000, // Definido GIC2 manual
        //TIMER4_BASE                 = 0xe000e010, // SysTick
        IC1_BASE                    = 0x1E030000, // Definido GIC3 manual
        PER_BASE                    = 0x1F000000 //Definido
    };
